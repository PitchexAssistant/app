        ...
        <div className="flex flex-col justify-start items-start gap-3">
          ...
          {!isCollapsed && (
            <div className="self-stretch h-10 px-3 inline-flex justify-between items-center">
              <div 
                className="text-neutral-400 font-medium font-['Uber_Move']"
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            ...
            <div className={`self-stretch rounded-xl inline-flex justify-start items-start ${isCollapsed ? 'justify-center' : 'hover:bg-zinc-900 rounded-xl cursor-pointer'}`}>
              <div className={`flex-1 h-11 px-0 py-2 rounded-xl flex items-center overflow-hidden ${isCollapsed ? 'justify-center' : 'justify-start gap-3 px-3 hover:bg-zinc-900 rounded-xl cursor-pointer'}`}>
                ...
                {!isCollapsed && (
                  <div className="flex justify-between w-full">
                    ...
                    <div className="h-6 px-2 py-[5px] bg-amber-500/10 rounded-md flex justify-center items-center">
                      <div 
                        className="text-amber-500 font-medium font-['Uber_Move']"
                        style={{ fontSize: 'var(--font-size-caption-xs)' }}
                      >
                        Coming Soon
                      </div>
                    </div>
                ...
                <div className="self-stretch w-full h-11 px-3 py-2 rounded-xl inline-flex justify-between items-center overflow-hidden">
                  <div className="flex justify-start items-center gap-3">
                    ...
                    <div className="h-6 px-2 py-[5px] bg-pink-500/10 rounded-[5.13px] flex justify-center items-center">
                      <div 
                        className="text-pink-500 font-medium font-['Uber_Move']"
                        style={{ fontSize: 'var(--font-size-caption-xs)' }}
                      >
                        6
                      </div>
        ...
        <div className="self-stretch pb-8 flex flex-col justify-start items-start gap-6">
          ...
          {!isCollapsed && (
            <div className="self-stretch p-4 rounded-2xl outline outline-1 outline-offset-[-1px] outline-zinc-800 flex flex-col justify-start items-start gap-3">
              ...
              <div 
                className="text-stone-300 font-medium font-['Uber_Move']"
                style={{ fontSize: 'var(--font-size-body)' }}
              >
                Upgrade to Pro
              </div>
              <div 
                className="text-neutral-500 font-medium font-['Uber_Move']"
                style={{ fontSize: 'var(--font-size-caption)' }}
              >
          ...
          <div className="px-3 flex justify-center">    
            <div className="self-stretch inline-flex justify-between items-start">
              <div className="flex justify-start items-center gap-2">
                ...
                <div className="inline-flex flex-col justify-start items-start max-w-[200px]">
                  <div 
                    className="text-zinc-100 font-medium font-['Uber_Move']"
                    style={{ fontSize: 'var(--font-size-caption)' }}
                  >
                    {user.name}
                  </div>
                  <div 
                    className="text-stone-500 font-medium font-['Uber_Move'] truncate w-[calc(100%-1rem)] overflow-hidden text-ellipsis whitespace-nowrap"
                    style={{ fontSize: 'var(--font-size-caption-xs)' }}
                  >
                    {user.email}
                  </div>
